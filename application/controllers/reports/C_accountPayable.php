...
class C_accountPayable extends MY_Controller{
    ...
    function printPDF($from_date, $to_date)
    {
        ...
        $pdf->Cell(50, 10, strtoupper(lang('account_payable')).' '.strtoupper(lang('report')), 0, 1,"C");
        ...
        $pdf->Cell(80, 9, strtoupper(lang('supplier')), 1, 0);
        ...
        foreach ($suppliers as $key => $list) {
            ...
            $pdf->Cell(40, 9, strtoupper(lang('bill')), "R", 0, "C");
            $pdf->Cell(30, 9, "", "R", 0, "C");
