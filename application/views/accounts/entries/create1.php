		...
		<table class="table table-bordered table-hover">
			...
			<tbody>
				...
				<tr ng:repeat="item in entries.items">
					...
					<td><textarea name="" ng:model="item.narration" class="form-control">{{item.narration}}</textarea></td>
					<td>
			...
			<tfoot>
				...
				<tr>
					<td colspan="5"><button type="submit" ng-click="saleEntries();" ng-disabled="cart_loader" class="btn btn-success">Save</button>
