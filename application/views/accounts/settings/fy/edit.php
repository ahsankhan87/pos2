...
foreach ($Fyear as $row) {
    ...
    echo '<label class="control-label col-md-3" for="fy_start_date">'.lang('start').' '.lang('date').'</label>';
    ...
    echo '<div class="form-group">';
    echo '<label class="control-label col-md-3" for="fy_start_date">'.lang('end').' '.lang('date').'</label>';
    echo '<div class="col-md-4">';
    ...
    echo '<div class="form-group">';
    echo '<label class="control-label col-md-3" for="fy_year">'.lang('description').'</label>';
    echo '<div class="col-md-4">';
    ...
    echo form_submit('submit', lang('edit'), 'class="btn btn-success"');
    echo '</div>';
}
echo '</div>';
echo form_close();
