<div class="row">
	...
	<div class="portlet">
        ...
        <?php foreach($purchasepostingType as $values): ?>
			<!-- BEGIN FORM-->
			<form action="<?php echo site_url('setting/PostingTypes/edit_purchase'); ?>" method="post" class="form-horizontal">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
						...
						<div class="col-md-4">
							<p class="form-control-static">
								 <?php echo form_dropdown('payable_acc_code',$accountDDL,$values['payable_acc_code'],'class="form-control select2me"'); ?>
							</p>
						</div>
					</div>
                    <div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<p class="form-control-static">
								 <?php echo form_dropdown('purchasereturn_acc_code',$accountDDL,$values['purchasereturn_acc_code'],'class="form-control select2me"'); ?>
							</p>
						</div>
					</div>
                    <div class="form-group">
						...
						<div class="col-md-4">
							<p class="form-control-static">
								 <?php echo form_dropdown('purchasedis_acc_code',$accountDDL,$values['purchasedis_acc_code'],'class="form-control select2me"'); ?>
							</p>
						</div>
					</div>
