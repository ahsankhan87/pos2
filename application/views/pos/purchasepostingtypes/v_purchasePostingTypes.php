<div class="row">
    ...
    ?>
    <p><?php echo anchor('setting/PostingTypes/create_purchase','Add New <i class="fa fa-plus"></i>','class="btn btn-success"'); ?></p>
    ...
    foreach($salespostingType as $key => $list)
    {
       ...
       echo '<td>';
        ...
        echo '<a href="'.site_url("setting/PostingTypes/edit_purchase/".$list['id']).'"  class="fa fa-edit" title="Edit"></a>  |
        <a href="'.site_url('setting/PostingTypes/delete_purchase/'.$list['id']).'" class="fa fa-trash-o" title="Delete" onclick="return confirm(\'Are you sure you want to delete?\')" class="btn btn-danger"></a>';
