<div class="row">
	...
	<div class="portlet">
		...
		<div class="portlet-body form">
			<!-- BEGIN FORM-->
			<form action="<?php echo site_url('setting/PostingTypes/create'); ?>" method="post" class="form-horizontal">
				<div class="form-body">
                    ...
                    <div class="form-group">
						...
						<div class="col-md-4">
							<p class="form-control-static">
								 <?php echo form_dropdown('sales_acc_code',$accountDDL,'','class="form-control select2me"'); ?>
							</p>
						</div>
					</div>
                    <div class="form-group">
						...
						<div class="col-md-4">
							<p class="form-control-static">
								 <?php echo form_dropdown('receivable_acc_code',$accountDDL,'','class="form-control select2me"'); ?>
							</p>
						</div>
					</div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
						...
						<div class="col-md-4">
							<p class="form-control-static">
								 <?php echo form_dropdown('cos_acc_code',$accountDDL,'','class="form-control select2me"'); ?>
							</p>
						</div>
					</div>
                    ...
                    <div class="form-group">
						...
						<div class="col-md-4">
							<p class="form-control-static">
								 <?php echo form_dropdown('salesreturn_acc_code',$accountDDL,'','class="form-control select2me"'); ?>
							</p>
						</div>
					</div>
                    <div class="form-group">
						...
						<div class="col-md-4">
							<p class="form-control-static">
								 <?php echo form_dropdown('salesdis_acc_code',$accountDDL,'','class="form-control select2me"'); ?>
							</p>
						</div>
					</div>
