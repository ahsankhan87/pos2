<div ng-controller="purchaseordersCtrl" ng-init="getAllProduct();">
...
<div class='col-xs-12 col-sm-9 col-md-9 col-lg-9'>
   <div class="row">
    ...
    <?php 
     ...
     echo '<input type="hidden" name="purchaseType" ng-model="purchaseType" ng-init="purchaseType=\'purchase order\'"  value="purchase order"/>';
     echo '<input type="hidden" name="register_mode" ng-model="register_mode" ng-init="register_mode=\'purchase order\'"  value="purchase order"/>';
