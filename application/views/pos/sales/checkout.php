...
<div id="cart_body">
<?php echo form_open('pos/C_sales/sales'); ?>
...
<tbody>
	<tr>
	 ...
	 <td><?php echo $this->cart->format_number($items['price']); ?></td>
      ...
      <td><?php echo anchor('pos/C_sales/removeCart/'.$items['rowid'],'X'); ?></a></td>
	</tr>
...
<tr>
  ...
  <td><?php echo anchor('pos/C_sales/destroyCart/','Destroy'); ?></td>
</tr>
</tbody>
</table>

<p><?php echo form_submit('', 'Sale','class="btn btn-success"'); ?></p>
<?php echo form_close(); ?>
