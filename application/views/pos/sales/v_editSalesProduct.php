<div ng-controller="editSalesProductCtrl" ng-init="getAllProduct(); editProductList('<?php echo @$invoice_no; ?>',<?php echo @$edit; ?>);">
<div class='row'>  
         ...
         <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="radio-list">
                    ...
                    <input type="radio" name="saleType" ng-model="saleType" id="cash" value="cash"  ng-init="saleType='cash'" checked=""> </div> Cash </label>
        			
                    <label class="radio-inline">
        			<div class="radio" id="uniform-optionsRadios5">
                    <input type="radio" name="saleType" ng-model="saleType" ng-init="saleType='credit'" id="credit" value="credit"  ></div> Credit </label>
         ...
         <div class="col-sm-4" ng-init="register_mode='sale'">
             <div class="form-group">
                 <div class="radio-list">
        			<label class="radio-inline">
        			<div class="radio" id="uniform-optionsRadios4">
                    <input type="radio" name="register_mode" ng-model="register_mode" id="optionsRadios6" value="sale" ng-init="register_mode='sale'" checked=""></div> Sale </label>
        			
                    <label class="radio-inline">
        			<div class="radio" id="uniform-optionsRadios5">
                    <input type="radio" name="register_mode" ng-model="register_mode" id="optionsRadios7" value="return" ng-init="register_mode='return'"></div> Return </label>
        ...
        <div class="form-group">
            ...
            <label class="control-label col-sm-2" for="">Customer</label>
             <div class="col-sm-4" ng-init="customer_id=''">
                <select class="form-control select2me" id="cust" ng:model="customer_id">
                <?php
        ...
        <div class="form-group">
            ...
            <label class="control-label col-sm-2" for="">Employee</label>
             <div class="col-sm-4" ng-init="emp_id=''">
                <select class="form-control select2me" id="emp" ng:model="emp_id">
        ...
        <div class="form-group">
            ...
            <label class="control-label col-sm-2" for="">Supplier</label>
             <div class="col-sm-4" ng-init="supplier_id=''">
                <select class="form-control select2me" ng:model="supplier_id">
		...
		<table class="table table-bordered table-hover">
			...
			<tbody>
			 ...
			 <tr ng:repeat="item in invoice.items" ng-init="subForm='cellForm'+$index">
                   ...
                   <input type="text" ng:model="item.name" class="form-control" readonly="" /></td>           
             ...
             <tr>
                ...
                <td class=""><!-- {{total() | currency:home_currency_symbol}}--></td>
                <td></td> 
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    <input type="checkbox" ng:model="is_taxable" ng-checked="is_taxable" name="is_taxable" id="is_taxable" />
            ...
            <tr>
                ...
                <td>
                    ...
                    <!-- Total discount percent -->
                    {{(total()-Tdiscount_value()) | currency:PRs}}
            ...
            <tr>
                <td colspan="6"><button type="submit" ng-click="UpdateSaleProducts();" ng-disabled="cart_loader && SaleForm.$dirty && SaleForm.$invalid" class="btn btn-success">Update</button>
