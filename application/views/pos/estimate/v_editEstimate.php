            ...
            <table class="table table-striped table-bordered" id="sale_table">
                ...
                <tfoot>
                    <tr>
                        ...
                        <th class="text-right" id="sub_total__"></th>
                    ...
                    <!-- </tr> -->
                    <tr>
                        <th colspan="5"><?php echo form_submit('', lang('update'), 'class="btn btn-success"'); ?></th>
        ...
        $("form").on("submit", function(e) {
            ...
            if (confirmSale) {
                ...
                if (formValues.length > 0) {
                    $.ajax({
                        type: "POST",
                        url: site_url + "pos/C_estimate/sale_transaction/" + 1 + "/" + estimate_invoice_no,
                        data: formValues,
                        success: function(data) {
                            if (data == '1') {
                                toastr.success("Estimate #;" + estimate_invoice_no + " updated successfully", 'Success');
