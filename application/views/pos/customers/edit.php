...
<div class="form-group">
  ...
  <div class="col-sm-10">
    <?php echo form_dropdown('posting_type_id',$salesPostingTypeDDL,$values['posting_type_id'],'class="form-control select2me" required=""'); ?>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <?php echo form_dropdown('emp_id',$emp_DDL,$values['emp_id'],'class="form-control select2me"'); ?>
  </div>
</div> -->

<div class="form-group">
  <label class="control-label col-sm-2" for="customer Name"><?php echo lang('first').' '.lang('name');?>:</label>
  <div class="col-sm-10">
    <input type="text" class="form-control" id="first_name" name="first_name" value="<?php echo $values['first_name']; ?>" required="" placeholder="Customer First Name"/>
  </div>
</div>

<div class="form-group">
  <label class="control-label col-sm-2" for="middle_name"><?php echo lang('middle').' '.lang('name');?>:</label>
  <div class="col-sm-10">
    <input type="text" class="form-control" id="middle_name" name="middle_name" value="<?php echo $values['middle_name']; ?>" placeholder="Middle Name" />
  </div>
</div>

<div class="form-group">
  <label class="control-label col-sm-2" for="customer Name"><?php echo lang('last').' '.lang('name');?>:</label>
  <div class="col-sm-10">
...
<div class="form-group">
  <label class="control-label col-sm-2" for="Company"><?php echo lang('store').' '.lang('name');?>:</label>
  <div class="col-sm-10">
    <input type="text" class="form-control" id="Company" name="store_name" value="<?php echo $values['store_name']; ?>" required="" placeholder="Company Name"/>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-sm-10">
    <input type="email" class="form-control" id="Email" name="email" value="<?php echo $values['email']; ?>" placeholder="Customer Email"/>
  </div>
</div>
...
<div class="form-group">
  <label class="control-label col-sm-2" for=" "><?php echo lang('city');?>:</label>
  <div class="col-sm-10">
...
echo '<div class="form-group"><label class="control-label col-sm-2" for="">'.lang('country').'</label>';
...
<div class="form-group">
  <label class="control-label col-sm-2" for="Phone"><?php echo lang('phone');?>:</label>
  <div class="col-sm-10">
    <input type="number" class="form-control" id="Phone" name="phone_no" value="<?php echo $values['phone_no']; ?>" placeholder="Phone No" />
  </div>
</div>

<div class="form-group">
  <label class="control-label col-sm-2" for="Mobile"><?php echo lang('mobile');?>:</label>
  <div class="col-sm-10">
...
<div class="form-group">
  ...
  <div class="col-sm-10">
    <input type="number" class="form-control" id="Fax" name="fax_no" value="<?php echo $values['fax_no']; ?>" placeholder="Fax No" />
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-sm-10">
    <input type="text" class="form-control" id="Website" name="website" value="<?php echo $values['website']; ?>" placeholder="Website" />
  </div>
</div>
 -->
