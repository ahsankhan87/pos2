                    	...
                    	<div class="form-body" >
                            ...
                            <div class="form-group">
                                 ...
                                 <label class="control-label col-sm-2" for="">Payment Mode</label>
                                     <div class="col-sm-4">
                                         <!-- <div class="checkbox"> -->
                                         <label class="control-label" for="cash"> Cash: </label><input type="radio" checked="" id="cash" ng-model="payment_type" ng-init="payment_type='cash'" name="payment_type" value="cash" />
                                         <br/>
                                         <label class="control-label" for="bank"> Cheque: </label><input type="radio" id="bank" ng-model="payment_type" name="payment_type"  value="bank" />
                                        <!-- </div>  -->
                                     </div>
