...
echo form_open('pos/Sizes/create',$attributes);

?>
<div class="form-group">
  <label class="control-label col-sm-2" for="Name">Size Name:<span class="required">* </span></label>
  <div class="col-sm-10">
...
echo '<div class="col-sm-10">';
echo form_submit('submit','Submit Size','class="btn btn-success"');
echo '</div></div>';
