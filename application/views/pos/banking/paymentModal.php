...
<div class="panel panel-default">
    <div class="panel-heading">
        <i class="fa fa-bar-chart-o fa-fw"></i> <?php echo @$list['first_name'] . ' '. @$list['last_name'] ?> Account Detail
    </div>
    <!-- /.panel-heading -->
    <div class="panel-body">
        ...
        <table class="table table-striped table-hover" id="sample_customer">
        <thead>
            <tr>
                <th>ID</th>
                <th>Date</th>
