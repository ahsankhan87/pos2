...
echo form_open('companies/C_companies/create',$attributes);
?>
...
<div class="form-group">
  ...
  <div class="small">i.e 01/01/2016</div></label>
  <div class="col-sm-10">
    <input type="text" class="form-control" id="datepicker" name="fy_start" placeholder=""/>
  </div>
</div>

<div class="form-group">
  <label class="control-label col-sm-2" for="fy_end">Fiscal Year End:
   <div class="small">i.e 31/12/2016</div></label>
  <div class="col-sm-10">
    <input type="text" class="form-control" id="Todatepicker" name="fy_end" placeholder=""/>
  </div>
</div>
