...
class M_receivings extends CI_Model
{
    ...
    function get_creditPurchases($supplier_id)
    {
        ...
        $query = $this->db->get_where('pos_receivings', array(
            'account' => 'credit', 'register_mode' => 'receive',
    ...
    {
        $this->db->select('A.receiving_date,A.due_date,A.amount_due,A.description,A.register_mode,A.employee_id,A.supplier_id,A.total_tax,A.total_amount,
