var Reports = (function () {
  ...
  var initTable__sales_reports = function () {
    ...
    var oTable = table.dataTable({
      ...
      footerCallback: function (row, data, start, end, display) {
        ...
        // Update footer
        $(api.column(5).footer()).html(pageTotal_5);

        $(api.column(6).footer()).html(pageTotal.toFixed(2));

        $(api.column(7).footer()).html(pageTotal_7);

        $(api.column(8).footer()).html(pageTotal_8.toFixed(2));

        $(api.column(9).footer()).html(pageTotal_9.toFixed(2));
      },
      ///////////////////////////
      ...
      buttons: [
        ...
        },
        {
          ...
          messageTop: function () {
            ...
            header +=
              '<p style="font-size:14px">' + $("#print_title").text() + "</p>";

            return header;
          },
          messageBottom:
            '<span style="text-align:center;">Powered by: Powered by: khybersoft.com</span>',
        },
        "colvis",
      ],
      columnDefs: [
  ...
  var receiving_reports = function () {
    ...
    var oTable = table.dataTable({
      ...
      footerCallback: function (row, data, start, end, display) {
        ...
        $(api.column(7).footer()).html(pageTotal_7.toFixed(2));
      },
      ///////////////////////////
      ...
      buttons: [
        ...
        },
        {
          ...
          messageBottom:
            '<span style="text-align:center;">Powered by: <i>Powered by: <i>khybersoft.com</i></span>',
        },
        "colvis",
      ],
      columnDefs: [
    ...
    var oTable = table.dataTable({
      ...
      buttons: [
        ...
        },
        {
          ...
          messageBottom:
            '<span style="text-align:center;">Powered by: <i>khybersoft.com</i></span>',
  ...
  var category_sales_summary = function () {
    ...
    var oTable = table.dataTable({
      footerCallback: function (row, data, start, end, display) {
        ...
        // Update footer
        $(api.column(3).footer()).html(pageTotal_3.toFixed(2));
      },
  ...
  var pdf_report = function () {
    var table = $('#pdf_report');
