...
(1, 0, 1, '1', 'Assets', 'اثاثہ جات', 'الأصول', 'assets', '0.00', '0.00', 'group', '1', 21, '2017-10-20 15:10:42'),
(2, 0, 3, '2', 'Liabilities', 'واجبات', 'المطلوبات', 'Liabilities', '0.00', '0.00', 'group', '1', 21, '2017-10-20 15:10:42'),
(3, 0, 2, '3', 'Equity', 'ایکوٹی', 'القيمة المالية', 'equity', '0.00', '0.00', 'group', '1', 21, '2017-10-20 15:10:42'),
(4, 0, 5, '4', 'Revenue', 'آمدنی', 'إيرادات', 'revenue', '0.00', '0.00', 'group', '1', 21, '2017-10-20 15:10:42'),
(5, 0, 6, '5', 'Cost of Goods Sold', 'فروخت سامان کی قیمت', 'تكلفة البضاعة المباعة', 'cos', '0.00', '0.00', 'group', '1', 21, '2017-10-20 15:10:42'),
(6, 0, 4, '6', 'Expenses', 'اخراجات', 'نفقات', 'expenses', '0.00', '0.00', 'group', '1', 21, '2017-10-20 15:10:42'),
(7, 1, 1, '10', 'Current Assets', 'موجودہ اثاثہ جات', 'الاصول المتداولة', 'current_assets', '0.00', '0.00', 'group', '2', 21, '2017-10-20 15:10:42'),
(8, 1, 1, '12', 'Fixed Assets', 'مقرر اثاثے', 'أصول ثابتة', 'fixed_assets', '0.00', '0.00', 'group', '2', 21, '2017-10-20 15:10:42'),
(9, 1, 1, '13', 'Other Assets', 'دیگر اثاثے', 'الأصول الأخرى', 'other_assets', '0.00', '0.00', 'group', '2', 21, '2017-10-20 15:10:42'),
(10, 2, 3, '20', 'Current Liabilities', 'موجودہ قرضوں', 'المطلوبات المتداولة', 'current_liabilities', '0.00', '0.00', 'group', '2', 21, '2017-10-20 15:10:42'),
(11, 2, 3, '21', 'Long Term Liabilities', 'طویل مدتی واجبات', 'مطلوبات طويلة الأجل', 'long_term_liabilities', '0.00', '0.00', 'group', '2', 21, '2017-10-20 15:10:42'),
(12, 3, 2, '30', 'Equity Account', 'ایکوئٹی اکاؤنٹ', 'حساب الأسهم', 'equity_account', '0.00', '0.00', 'group', '2', 21, '2017-10-20 15:10:42'),
(13, 4, 5, '40', 'Revenue Account', 'ریونیو اکاؤنٹ', 'حساب الإيرادات', 'revenue_account', '0.00', '0.00', 'group', '2', 21, '2017-10-20 15:10:42'),
(14, 5, 6, '50', 'Cost of goods sold', 'فروخت سامان کی قیمت', '', 'cogs', '0.00', '0.00', 'group', '2', 21, '2017-10-20 15:10:42'),
(15, 6, 4, '60', 'Operative Expenses', 'آپریٹو اخراجات', 'المصروفات التشغيلية', 'operative_expenses', '0.00', '0.00', 'group', '2', 21, '2017-10-20 15:10:42'),
(16, 10, 1, '1001', 'Cash on Hand', 'ہاتھ پر نقد', 'النقد في الصندوق', 'cash_hand', '0.00', '0.00', 'detail', '3', 21, '2017-10-20 15:10:42'),
(17, 10, 1, '1002', 'Cash at Bank', 'بینک پر کیش', 'النقدية في البنك', 'cashatbank', '0.00', '0.00', 'detail', '3', 21, '2017-10-20 15:10:42'),
(18, 10, 1, '1003', 'Accounts Receivable', 'وصولی اکاؤنٹس', 'الحسابات المستحقة', 'accounts_receivable', '0.00', '0.00', 'detail', '3', 21, '2017-10-20 15:10:42'),
(19, 10, 1, '1004', 'Inventory', 'انوینٹری', 'المخزون', 'inventory', '125600.00', '0.00', 'detail', '3', 21, '2017-10-20 15:10:42'),
(20, 20, 3, '2000', 'Accounts Payable', 'واجب الادا کھاتہ', 'حسابات قابلة للدفع', 'accounts_payable', '0.00', '0.00', 'detail', '3', 21, '2017-10-20 15:10:42'),
(21, 30, 2, '3000', 'Capital', 'کیپٹل', 'عاصمة', 'capital', '0.00', '0.00', 'detail', '3', 21, '2017-10-20 15:10:42'),
(22, 30, 2, '3001', 'Retained Earnings', 'برقرار رکھا کمائی', 'الأرباح المحتجزة', 'retained_earnings', '0.00', '0.00', 'detail', '3', 21, '2017-10-20 15:10:42'),
(23, 40, 5, '4000', 'Sales', 'سیلز', 'مبيعات', 'sales', '0.00', '0.00', 'detail', '3', 21, '2017-10-20 15:10:42'),
(24, 40, 5, '4001', 'Sales Returns and Allowances', 'فروخت کی واپسی اور الاؤنسز', 'عوائد المبيعات والبدلات', 'sales_allowances', '0.00', '0.00', 'detail', '3', 21, '2017-10-20 15:10:42'),
(25, 40, 5, '4002', 'Sales Discounts', 'سیلز ڈسکاؤنٹس', 'تخفيض المبيعات', 'sales_discounts', '0.00', '0.00', 'detail', '3', 21, '2017-10-20 15:10:42'),
...
(13, 4, 'C_receivings', 'Bill', 'خریداری', 'المشتريات', 'fa fa-edit fa-fw', 'C_receivings/index/credit', '12', 'active'),
(14, 2, 'C_sales', 'Sales Receipt', 'فروخت', 'مبيعات', 'fa fa-files-o fa-fw', 'C_sales/allSales', '20', 'active'),
(15, 3, 'C_groups', 'Chart of Accounts', 'اکاؤنٹس کا چارٹ', 'جدول الحسابات', 'fa fa-files-o fa-fw', 'C_groups', '10', 'active'),
(16, 2, 'C_sales', 'Invoices', '', '', 'fa fa-files-o fa-fw', 'C_sales//index/credit', '20', 'active'),
(17, 3, 'C_entries', 'Journal Entries', 'جرنل اندراج', 'إدخالات دفتر اليومية', 'fa fa-files-o fa-fw', 'C_entries', '30', 'active'),
(40, 5, 'C_salesreport', 'Sales Report', 'فروخت رپورٹ', 'تقرير المبيعات', 'fa fa-files-o fa-fw', 'C_salesreport', '10', 'active'),
...
(29, 2, 'C_units', 'Units', 'یونٹ', 'الوحدات', '', 'C_units', '55', 'inactive'),
...
ALTER TABLE `pos_sales_items` ADD `account_code` VARCHAR(100) NULL AFTER `item_id`;
ALTER TABLE `pos_sales` ADD `deposit_to_acc_code` VARCHAR(100) NULL AFTER `sale_date`;
